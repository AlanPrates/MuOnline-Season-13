...
public:
	...
	bool ApplyOnSilverHeartSet(LPOBJ lpObj, int SourceSlot, int TargetSlot);
	...
	bool ApplyOnSilverHeartWeapon(LPOBJ lpObj, int SourceSlot, int TargetSlot);

	bool ApplyOnSilverHeartShield(LPOBJ lpObj, int SourceSlot, int TargetSlot);
