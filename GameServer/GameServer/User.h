...
struct OBJECTSTRUCT
{
	...
	*/
	...
	long long ShieldDamageReductionTime;
	...
	int FreezingDamageResist;
	int FireingDamageRate;
	int FireingDamageResist;
	...
	int BackSpringIncrease;

	long long LastMoveSkillTimer;

	bool OficinaOpen;
	int OficinaItem;
	BYTE OficinaOptions[5];

	BYTE CashShopDiscount;

	bool ForcePvP;
	long long ForcePvPTime;
