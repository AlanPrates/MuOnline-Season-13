...
enum eChaosMixNumber
{
	...
	CHAOS_MIX_SILVER_HEART_SET_START = 526,
	CHAOS_MIX_SILVER_HEART_SET_END = 530,

	CHAOS_MIX_SILVER_HEART_WEAPON_START = 531,
	CHAOS_MIX_SILVER_HEART_WEAPON_END = 541,
...
public:
	...
	void AncestralSilverHeartItemMix(LPOBJ lpObj);
	void SoulWeaponMix(LPOBJ lpObj);
	void BlueEyeWeaponMix(LPOBJ lpObj);
	void SilverHeartWeaponMix(LPOBJ lpObj);
