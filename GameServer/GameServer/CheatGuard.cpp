...
void CheatGuard::HardIdRecv(int aIndex, HARDWARE_ID_RECV * pResult)
{
	...
	gObj[aIndex].HardDiskId[15] = '\0';

	LogAdd(LOG_BLACK, "[HardDiskId] %s :: %s", gObj[aIndex].Name, gObj[aIndex].HardDiskId);
