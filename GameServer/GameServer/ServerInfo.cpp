...
void CServerInfo::ReadCharacterInfo() // OK
{
	...
	this->ReadCharacterElementalInfo("GameServerInfo", ".\\Data\\GameServerInfo - Elemental.dat");
...
void CServerInfo::ReadCustomInfo() // OK
{
	...
	gCustomPvPTime.Load(gPath.GetRightPath("Custom\\CustomPvPTime.txt"));
...
void CServerInfo::ReadEventInfo() // OK
{
	...
	gMonsterSpawner.Load(gPath.GetRightPath("Monster\\MonsterSpawner.txt"));
...
void CServerInfo::ReadMonsterSetBase() // OK
{
...
void CServerInfo::ReadMoveInfo() // OK
{
	...
	gMapManager.LoadPvPZone(gPath.GetRightPath("Move\\PvPZone.txt"));
...
void CServerInfo::ReadUtilInfo() // OK
{
	...
	gOficina.LoadDescriptions(gPath.GetRightPath("Oficina\\description.txt"));
	gOficina.LoadOptions(gPath.GetRightPath("Oficina\\options.txt"));

	gNotice.Load(gPath.GetRightPath("Util\\Notice.txt"));

	char* section = "GameServerInfo";
	char* path = ".\\Data\\GameServerInfo - Event.dat";
	...
	this->m_CastleSiegeLowerAccumulatedTimeFixed = GetPrivateProfileInt(section, "CastleSiegeLowerAccumulatedTimeFixed", 0, path);

	this->m_CastleSiegeCrownIdleTimeout = GetPrivateProfileInt(section, "CastleSiegeCrownIdleTimeout", 0, path);
	this->m_CastleSiegeMaxMembersInTower = GetPrivateProfileInt(section, "CastleSiegeMaxMembersInTower", 999, path);

	this->m_CastleSiegeExtend			= GetPrivateProfileInt(section, "CastleSiegeExtend", 0, path);
	this->m_CastleSiegeExtendTime		= GetPrivateProfileInt(section, "CastleSiegeExtendTime", 0, path);
	this->m_CastleSiegeExtendCondition	= GetPrivateProfileInt(section, "CastleSiegeExtendCondition", 0, path);
	this->m_CastleSiegeTimeToRegister	= GetPrivateProfileInt(section, "CastleSiegeTimeToRegister", 60000, path);
	this->m_CastleSiegeWinningMode		= GetPrivateProfileInt(section, "CastleSiegeWinningMode", 1, path);
...
void CServerInfo::ReloadMonsterSetBase() // OK
{
	LogAdd(LOG_RED, "[MonsterSetBase] Reloading...");
	...
	LogAdd(LOG_BLUE, "[MonsterSetBase] Reloaded.");
}
...
void CServerInfo::ReadStartupInfo(char* section, char* path) // OK
{
	...
	this->m_WriteMonsterSpawnerLog = GetPrivateProfileInt(section, "WriteMonsterSpawnerLog", 0, path);
}
...
void CServerInfo::ReadChaosMixInfo(char* section, char* path) // OK
{
	...
	this->m_ChaosDarkAngelLuckRate = GetPrivateProfileInt(section, "ChaosDarkAngelLuckRate", 0, path);	//������ʹ��װ�ϳ����˸���
	this->m_ChaosDarkAngelSet = GetPrivateProfileInt(section, "ChaosDarkAngelSet", 0, path);			//������ʹ��װ�ϳ�+15ȫ���Լ���
	this->m_ChaosAngelEcxMaxRate = GetPrivateProfileInt(section, "ChaosAngelEcxMaxRate", 0, path);			//ȫ���Ը���
	this->m_ChaosAngelLuckRate = GetPrivateProfileInt(section, "ChaosAngelLuckRate", 0, path);			//���˸���
	this->m_ChaosDrakAngelInheritBloodAngelEcx = GetPrivateProfileInt(section, "ChaosDrakAngelInheritBloodAngelEcx", 0, path);

	this->m_AngelEcxAddSwitch = GetPrivateProfileInt(section, "AngelEcxAddSwitch", 0, path);			//�Ƿ���׿Խ����[��]:0[��]:1
	this->m_AngelEcxMaxOption = GetPrivateProfileInt(section, "AngelEcxMaxOption", 0, path);			//�������׿Խ����
...
void CServerInfo::ReadCharacterInfo(char* section, char* path) // OK
{
	...
	this->m_CustomArenaDamageRate = GetPrivateProfileInt(section, "CustomArenaDamageRate", 100, path);
	this->m_ChaosCastleDamageRate = GetPrivateProfileInt(section, "ChaosCastleDamageRate", 100, path);
	this->m_IllusionTempleDamageRate = GetPrivateProfileInt(section, "IllusionTempleDamageRate", 100, path);
	this->m_CastleSiegeDamageRate = GetPrivateProfileInt(section, "CastleSiegeDamageRate", 100, path);
	this->m_MUFCDamageRate = GetPrivateProfileInt(section, "MUFCDamageRate", 80, path);
	this->m_GeneralDamageRatePvP = GetPrivateProfileInt(section, "GeneralDamageRatePvP", 1000, path);
	this->m_GeneralDamageRatePvM = GetPrivateProfileInt(section, "GeneralDamageRatePvM", 100, path);
	this->m_ReflectDamageRatePvP = GetPrivateProfileInt(section, "ReflectDamageRatePvP", 100, path);
	this->m_CastleSiegeReflectRatePvP = GetPrivateProfileInt(section, "CastleSiegeReflectRate", 100, path);
	this->m_ReflectDamageRatePvM = GetPrivateProfileInt(section, "ReflectDamageRatePvM", 100, path);

	this->m_DamageRateByDistance[0] = GetPrivateProfileInt(section, "DamageRateByDistance0", 0, path);
	this->m_DamageRateByDistance[1] = GetPrivateProfileInt(section, "DamageRateByDistance1", 0, path);
	this->m_DamageRateByDistance[2] = GetPrivateProfileInt(section, "DamageRateByDistance2", 0, path);
	this->m_DamageRateByDistance[3] = GetPrivateProfileInt(section, "DamageRateByDistance3", 0, path);
	this->m_DamageRateByDistance[4] = GetPrivateProfileInt(section, "DamageRateByDistance4", 0, path);
	this->m_DamageRateByDistance[5] = GetPrivateProfileInt(section, "DamageRateByDistance5", 0, path);
	this->m_DamageRateByDistance[6] = GetPrivateProfileInt(section, "DamageRateByDistance6", 0, path);
	this->m_DamageRateByDistance[7] = GetPrivateProfileInt(section, "DamageRateByDistance7", 0, path);
	this->m_DamageRateByDistance[8] = GetPrivateProfileInt(section, "DamageRateByDistance8", 0, path);
	this->m_DamageRateByDistance[9] = GetPrivateProfileInt(section, "DamageRateByDistance9", 0, path);
	this->m_DamageRateByDistance[10] = GetPrivateProfileInt(section, "DamageRateByDistance10", 0, path);
	this->m_DamageRateByDistance[11] = GetPrivateProfileInt(section, "DamageRateByDistance11", 0, path);
	this->m_DamageRateByDistance[12] = GetPrivateProfileInt(section, "DamageRateByDistance12", 0, path);

	this->m_DamageRatePvP[0] = GetPrivateProfileInt(section, "DWDamageRatePvP", 100, path);
	this->m_DamageRatePvP[1] = GetPrivateProfileInt(section, "DKDamageRatePvP", 100, path);
	this->m_DamageRatePvP[2] = GetPrivateProfileInt(section, "FEDamageRatePvP", 100, path);
	this->m_DamageRatePvP[3] = GetPrivateProfileInt(section, "MGDamageRatePvP", 100, path);
	this->m_DamageRatePvP[4] = GetPrivateProfileInt(section, "DLDamageRatePvP", 100, path);
	this->m_DamageRatePvP[5] = GetPrivateProfileInt(section, "SUDamageRatePvP", 100, path);
	this->m_DamageRatePvP[6] = GetPrivateProfileInt(section, "RFDamageRatePvP", 100, path);
	this->m_DamageRatePvP[7] = GetPrivateProfileInt(section, "GLDamageRatePvP", 100, path);

	this->m_DamageRatePvM[0] = GetPrivateProfileInt(section, "DWDamageRatePvM", 100, path);
	this->m_DamageRatePvM[1] = GetPrivateProfileInt(section, "DKDamageRatePvM", 100, path);
	this->m_DamageRatePvM[2] = GetPrivateProfileInt(section, "FEDamageRatePvM", 100, path);
	this->m_DamageRatePvM[3] = GetPrivateProfileInt(section, "MGDamageRatePvM", 100, path);
	this->m_DamageRatePvM[4] = GetPrivateProfileInt(section, "DLDamageRatePvM", 100, path);
	this->m_DamageRatePvM[5] = GetPrivateProfileInt(section, "SUDamageRatePvM", 100, path);
	this->m_DamageRatePvM[6] = GetPrivateProfileInt(section, "RFDamageRatePvM", 100, path);
	this->m_DamageRatePvM[7] = GetPrivateProfileInt(section, "GLDamageRatePvM", 100, path);
	...
	this->m_DamageRateTo[7][0] = GetPrivateProfileInt(section, "GLDamageRateToDW", 0, path);
	this->m_DamageRateTo[7][1] = GetPrivateProfileInt(section, "GLDamageRateToDK", 0, path);
	this->m_DamageRateTo[7][2] = GetPrivateProfileInt(section, "GLDamageRateToFE", 0, path);
	this->m_DamageRateTo[7][3] = GetPrivateProfileInt(section, "GLDamageRateToMG", 0, path);
	this->m_DamageRateTo[7][4] = GetPrivateProfileInt(section, "GLDamageRateToDL", 0, path);
	this->m_DamageRateTo[7][5] = GetPrivateProfileInt(section, "GLDamageRateToSU", 0, path);
	this->m_DamageRateTo[7][6] = GetPrivateProfileInt(section, "GLDamageRateToRF", 0, path);
	this->m_DamageRateTo[7][7] = GetPrivateProfileInt(section, "GLDamageRateToGL", 0, path);

	this->m_X_DamageRateTo[0][0] = GetPrivateProfileInt(section, "X_DWDamageRateToDW", 0, path);
	this->m_X_DamageRateTo[0][1] = GetPrivateProfileInt(section, "X_DWDamageRateToDK", 0, path);
	this->m_X_DamageRateTo[0][2] = GetPrivateProfileInt(section, "X_DWDamageRateToFE", 0, path);
	this->m_X_DamageRateTo[0][3] = GetPrivateProfileInt(section, "X_DWDamageRateToMG", 0, path);
	this->m_X_DamageRateTo[0][4] = GetPrivateProfileInt(section, "X_DWDamageRateToDL", 0, path);
	this->m_X_DamageRateTo[0][5] = GetPrivateProfileInt(section, "X_DWDamageRateToSU", 0, path);
	this->m_X_DamageRateTo[0][6] = GetPrivateProfileInt(section, "X_DWDamageRateToRF", 0, path);
	this->m_X_DamageRateTo[0][7] = GetPrivateProfileInt(section, "X_DWDamageRateToGL", 0, path);
	this->m_X_DamageRateTo[1][0] = GetPrivateProfileInt(section, "X_DKDamageRateToDW", 0, path);
	this->m_X_DamageRateTo[1][1] = GetPrivateProfileInt(section, "X_DKDamageRateToDK", 0, path);
	this->m_X_DamageRateTo[1][2] = GetPrivateProfileInt(section, "X_DKDamageRateToFE", 0, path);
	this->m_X_DamageRateTo[1][3] = GetPrivateProfileInt(section, "X_DKDamageRateToMG", 0, path);
	this->m_X_DamageRateTo[1][4] = GetPrivateProfileInt(section, "X_DKDamageRateToDL", 0, path);
	this->m_X_DamageRateTo[1][5] = GetPrivateProfileInt(section, "X_DKDamageRateToSU", 0, path);
	this->m_X_DamageRateTo[1][6] = GetPrivateProfileInt(section, "X_DKDamageRateToRF", 0, path);
	this->m_X_DamageRateTo[1][7] = GetPrivateProfileInt(section, "X_DKDamageRateToGL", 0, path);
	this->m_X_DamageRateTo[2][0] = GetPrivateProfileInt(section, "X_FEDamageRateToDW", 0, path);
	this->m_X_DamageRateTo[2][1] = GetPrivateProfileInt(section, "X_FEDamageRateToDK", 0, path);
	this->m_X_DamageRateTo[2][2] = GetPrivateProfileInt(section, "X_FEDamageRateToFE", 0, path);
	this->m_X_DamageRateTo[2][3] = GetPrivateProfileInt(section, "X_FEDamageRateToMG", 0, path);
	this->m_X_DamageRateTo[2][4] = GetPrivateProfileInt(section, "X_FEDamageRateToDL", 0, path);
	this->m_X_DamageRateTo[2][5] = GetPrivateProfileInt(section, "X_FEDamageRateToSU", 0, path);
	this->m_X_DamageRateTo[2][6] = GetPrivateProfileInt(section, "X_FEDamageRateToRF", 0, path);
	this->m_X_DamageRateTo[2][7] = GetPrivateProfileInt(section, "X_FEDamageRateToGL", 0, path);
	this->m_X_DamageRateTo[3][0] = GetPrivateProfileInt(section, "X_MGDamageRateToDW", 0, path);
	this->m_X_DamageRateTo[3][1] = GetPrivateProfileInt(section, "X_MGDamageRateToDK", 0, path);
	this->m_X_DamageRateTo[3][2] = GetPrivateProfileInt(section, "X_MGDamageRateToFE", 0, path);
	this->m_X_DamageRateTo[3][3] = GetPrivateProfileInt(section, "X_MGDamageRateToMG", 0, path);
	this->m_X_DamageRateTo[3][4] = GetPrivateProfileInt(section, "X_MGDamageRateToDL", 0, path);
	this->m_X_DamageRateTo[3][5] = GetPrivateProfileInt(section, "X_MGDamageRateToSU", 0, path);
	this->m_X_DamageRateTo[3][6] = GetPrivateProfileInt(section, "X_MGDamageRateToRF", 0, path);
	this->m_X_DamageRateTo[3][7] = GetPrivateProfileInt(section, "X_MGDamageRateToGL", 0, path);
	this->m_X_DamageRateTo[4][0] = GetPrivateProfileInt(section, "X_DLDamageRateToDW", 0, path);
	this->m_X_DamageRateTo[4][1] = GetPrivateProfileInt(section, "X_DLDamageRateToDK", 0, path);
	this->m_X_DamageRateTo[4][2] = GetPrivateProfileInt(section, "X_DLDamageRateToFE", 0, path);
	this->m_X_DamageRateTo[4][3] = GetPrivateProfileInt(section, "X_DLDamageRateToMG", 0, path);
	this->m_X_DamageRateTo[4][4] = GetPrivateProfileInt(section, "X_DLDamageRateToDL", 0, path);
	this->m_X_DamageRateTo[4][5] = GetPrivateProfileInt(section, "X_DLDamageRateToSU", 0, path);
	this->m_X_DamageRateTo[4][6] = GetPrivateProfileInt(section, "X_DLDamageRateToRF", 0, path);
	this->m_X_DamageRateTo[4][7] = GetPrivateProfileInt(section, "X_DLDamageRateToGL", 0, path);
	this->m_X_DamageRateTo[5][0] = GetPrivateProfileInt(section, "X_SUDamageRateToDW", 0, path);
	this->m_X_DamageRateTo[5][1] = GetPrivateProfileInt(section, "X_SUDamageRateToDK", 0, path);
	this->m_X_DamageRateTo[5][2] = GetPrivateProfileInt(section, "X_SUDamageRateToFE", 0, path);
	this->m_X_DamageRateTo[5][3] = GetPrivateProfileInt(section, "X_SUDamageRateToMG", 0, path);
	this->m_X_DamageRateTo[5][4] = GetPrivateProfileInt(section, "X_SUDamageRateToDL", 0, path);
	this->m_X_DamageRateTo[5][5] = GetPrivateProfileInt(section, "X_SUDamageRateToSU", 0, path);
	this->m_X_DamageRateTo[5][6] = GetPrivateProfileInt(section, "X_SUDamageRateToRF", 0, path);
	this->m_X_DamageRateTo[5][7] = GetPrivateProfileInt(section, "X_SUDamageRateToGL", 0, path);
	this->m_X_DamageRateTo[6][0] = GetPrivateProfileInt(section, "X_RFDamageRateToDW", 0, path);
	this->m_X_DamageRateTo[6][1] = GetPrivateProfileInt(section, "X_RFDamageRateToDK", 0, path);
	this->m_X_DamageRateTo[6][2] = GetPrivateProfileInt(section, "X_RFDamageRateToFE", 0, path);
	this->m_X_DamageRateTo[6][3] = GetPrivateProfileInt(section, "X_RFDamageRateToMG", 0, path);
	this->m_X_DamageRateTo[6][4] = GetPrivateProfileInt(section, "X_RFDamageRateToDL", 0, path);
	this->m_X_DamageRateTo[6][5] = GetPrivateProfileInt(section, "X_RFDamageRateToSU", 0, path);
	this->m_X_DamageRateTo[6][6] = GetPrivateProfileInt(section, "X_RFDamageRateToRF", 0, path);
	this->m_X_DamageRateTo[6][7] = GetPrivateProfileInt(section, "X_RFDamageRateToGL", 0, path);
	this->m_X_DamageRateTo[7][0] = GetPrivateProfileInt(section, "X_GLDamageRateToDW", 0, path);
	this->m_X_DamageRateTo[7][1] = GetPrivateProfileInt(section, "X_GLDamageRateToDK", 0, path);
	this->m_X_DamageRateTo[7][2] = GetPrivateProfileInt(section, "X_GLDamageRateToFE", 0, path);
	this->m_X_DamageRateTo[7][3] = GetPrivateProfileInt(section, "X_GLDamageRateToMG", 0, path);
	this->m_X_DamageRateTo[7][4] = GetPrivateProfileInt(section, "X_GLDamageRateToDL", 0, path);
	this->m_X_DamageRateTo[7][5] = GetPrivateProfileInt(section, "X_GLDamageRateToSU", 0, path);
	this->m_X_DamageRateTo[7][6] = GetPrivateProfileInt(section, "X_GLDamageRateToRF", 0, path);
	this->m_X_DamageRateTo[7][7] = GetPrivateProfileInt(section, "X_GLDamageRateToGL", 0, path);
	...
	this->m_DamageStuckRate[7] = GetPrivateProfileInt(section, "GLDamageStuckRate", 0, path);*/
	...
	this->m_FKDamageMultiplierConstA = GetPrivateProfileInt(section, "GLDamageMultiplierConstA", 0, path);
	this->m_FKDamageMultiplierConstB = GetPrivateProfileInt(section, "GLDamageMultiplierConstB", 0, path);
	this->m_FKDamageMultiplierMaxRate = GetPrivateProfileInt(section, "GLDamageMultiplierMaxRate", 0, path);
	...
	this->m_HPRecoveryRate[7] = GetPrivateProfileInt(section, "GLHPRecoveryRate", 0, path);
	...
	this->m_MPRecoveryRate[7] = GetPrivateProfileInt(section, "GLMPRecoveryRate", 0, path);
	...
	this->m_BPRecoveryRate[7] = GetPrivateProfileInt(section, "GLBPRecoveryRate", 0, path);
	...
	this->m_SDRecoveryRate[0] = GetPrivateProfileInt(section, "GLSDRecoveryRate", 0, path);
	...
	this->m_FKPlasmaStormDamageConstA = GetPrivateProfileInt(section, "GLPlasmaStormDamageConstA", 0, path);
	this->m_FKPlasmaStormDamageConstB = GetPrivateProfileInt(section, "GLPlasmaStormDamageConstB", 0, path);
	this->m_FKPlasmaStormDamageConstC = GetPrivateProfileInt(section, "GLPlasmaStormDamageConstC", 0, path);
	this->m_FKPlasmaStormDamageConstD = GetPrivateProfileInt(section, "GLPlasmaStormDamageConstD", 0, path);
	...
	this->m_FKPhysiDamageMinConstA = GetPrivateProfileInt(section, "GLPhysiDamageMinConstA", 0, path);
	this->m_FKPhysiDamageMaxConstA = GetPrivateProfileInt(section, "GLPhysiDamageMaxConstA", 0, path);
	this->m_FKPhysiDamageMinConstB = GetPrivateProfileInt(section, "GLPhysiDamageMinConstB", 0, path);
	this->m_FKPhysiDamageMaxConstB = GetPrivateProfileInt(section, "GLPhysiDamageMaxConstB", 0, path);
	this->m_FKMagicDamageMinConstA = GetPrivateProfileInt(section, "GLMagicDamageMinConstA", 0, path);
	this->m_FKMagicDamageMaxConstA = GetPrivateProfileInt(section, "GLMagicDamageMaxConstA", 0, path);
	...
	this->m_FKAttackSuccessRateConstA = GetPrivateProfileInt(section, "GLAttackSuccessRateConstA", 0, path);
	this->m_FKAttackSuccessRateConstB = GetPrivateProfileInt(section, "GLAttackSuccessRateConstB", 0, path);
	this->m_FKAttackSuccessRateConstC = GetPrivateProfileInt(section, "GLAttackSuccessRateConstC", 0, path);
	this->m_FKAttackSuccessRateConstD = GetPrivateProfileInt(section, "GLAttackSuccessRateConstD", 0, path);
	...
	this->m_FKAttackSuccessRatePvPConstA = GetPrivateProfileInt(section, "GLAttackSuccessRatePvPConstA", 0, path);
	this->m_FKAttackSuccessRatePvPConstB = GetPrivateProfileInt(section, "GLAttackSuccessRatePvPConstB", 0, path);
	this->m_FKAttackSuccessRatePvPConstC = GetPrivateProfileInt(section, "GLAttackSuccessRatePvPConstC", 0, path);
	this->m_FKAttackSuccessRatePvPConstD = GetPrivateProfileInt(section, "GLAttackSuccessRatePvPConstD", 0, path);
	...
	this->m_FKPhysiSpeedConstA = GetPrivateProfileInt(section, "GLPhysiSpeedConstA", 0, path);
	this->m_FKMagicSpeedConstA = GetPrivateProfileInt(section, "GLMagicSpeedConstA", 0, path);
	...
	this->m_FKDefenseSuccessRateConstA = GetPrivateProfileInt(section, "GLDefenseSuccessRateConstA", 0, path);
	...
	this->m_FKDefenseSuccessRatePvPConstA = GetPrivateProfileInt(section, "GLDefenseSuccessRatePvPConstA", 0, path);
	this->m_FKDefenseSuccessRatePvPConstB = GetPrivateProfileInt(section, "GLDefenseSuccessRatePvPConstB", 0, path);
	this->m_FKDefenseSuccessRatePvPConstC = GetPrivateProfileInt(section, "GLDefenseSuccessRatePvPConstC", 0, path);

	this->m_ClassDefenseConst[CLASS_DW] = GetPrivateProfileInt(section, "DWDefenseConstA", 10, path);
	this->m_ClassDefenseConst[CLASS_DK] = GetPrivateProfileInt(section, "DKDefenseConstA", 10, path);
	this->m_ClassDefenseConst[CLASS_FE] = GetPrivateProfileInt(section, "FEDefenseConstA", 10, path);
	this->m_ClassDefenseConst[CLASS_MG] = GetPrivateProfileInt(section, "MGDefenseConstA", 10, path);
	this->m_ClassDefenseConst[CLASS_DL] = GetPrivateProfileInt(section, "DLDefenseConstA", 10, path);
	this->m_ClassDefenseConst[CLASS_SU] = GetPrivateProfileInt(section, "SUDefenseConstA", 10, path);
	this->m_ClassDefenseConst[CLASS_RF] = GetPrivateProfileInt(section, "RFDefenseConstA", 10, path);
	this->m_ClassDefenseConst[CLASS_GL] = GetPrivateProfileInt(section, "GLDefenseConstA", 10, path);

	this->MASTERY_OPTION_DAMAGE_AGAINST_[CLASS_DW] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_DW", 10, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_[CLASS_DK] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_DK", 10, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_[CLASS_FE] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_ELF", 10, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_[CLASS_MG] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_MG", 10, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_[CLASS_DL] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_DL", 10, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_[CLASS_SU] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_SUM", 10, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_[CLASS_RF] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_RF", 10, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_[CLASS_GL] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_GL", 10, path);

	this->MASTERY_OPTION_DAMAGE_AGAINST_2[CLASS_DW] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_DW2", 12, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_2[CLASS_DK] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_DK2", 12, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_2[CLASS_FE] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_ELF2", 12, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_2[CLASS_MG] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_MG2", 12, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_2[CLASS_DL] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_DL2", 12, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_2[CLASS_SU] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_SUM2", 12, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_2[CLASS_RF] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_RF2", 12, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_2[CLASS_GL] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_GL2", 12, path);

	this->MASTERY_OPTION_DAMAGE_AGAINST_3[CLASS_DW] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_DW3", 15, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_3[CLASS_DK] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_DK3", 15, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_3[CLASS_FE] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_ELF3", 15, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_3[CLASS_MG] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_MG3", 15, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_3[CLASS_DL] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_DL3", 15, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_3[CLASS_SU] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_SUM3", 15, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_3[CLASS_RF] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_RF3", 15, path);
	this->MASTERY_OPTION_DAMAGE_AGAINST_3[CLASS_GL] = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_GL3", 15, path);
	
	this->MASTERY_OPTION_DAMAGE_AGAINST_MAX = GetPrivateProfileInt(section, "MASTERY_OPTION_DAMAGE_AGAINST_MAX", 30, path);

	this->MASTERY_OPTION_INCREASE_BOSS_DAMAGE		= GetPrivateProfileInt(section, "MASTERY_OPTION_INCREASE_BOSS_DAMAGE", 15, path);
	this->MASTERY_OPTION_INCREASE_BOSS_DAMAGE2 = GetPrivateProfileInt(section, "MASTERY_OPTION_INCREASE_BOSS_DAMAGE2", 20, path);
	this->MASTERY_OPTION_INCREASE_BOSS_DAMAGE3 = GetPrivateProfileInt(section, "MASTERY_OPTION_INCREASE_BOSS_DAMAGE3", 25, path);
	this->MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE	= GetPrivateProfileInt(section, "MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE", 15, path);
	this->MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE2 = GetPrivateProfileInt(section, "MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE2", 20, path);
	this->MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE3 = GetPrivateProfileInt(section, "MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE3", 25, path);

	this->MASTERY_BONUS_TRIPLE_DAMAGE_RATE	= GetPrivateProfileInt(section, "MASTERY_BONUS_TRIPLE_DAMAGE_RATE", 2, path);
	this->MASTERY_BONUS_FINAL_DAMAGE		= GetPrivateProfileInt(section, "MASTERY_BONUS_FINAL_DAMAGE", 10, path);
	this->MASTERY_BONUS_ULTRAHIT_50			= GetPrivateProfileInt(section, "MASTERY_BONUS_ULTRAHIT_50", 1, path);
	this->MASTERY_BONUS_DOUBLE_DAMAGE_BOSS	= GetPrivateProfileInt(section, "MASTERY_BONUS_DOUBLE_DAMAGE_BOSS", 5, path);

	this->MASTERY_BONUS_TRIPLE_DAMAGE_RATE2 = GetPrivateProfileInt(section, "MASTERY_BONUS_TRIPLE_DAMAGE_RATE2", 3, path);
	this->MASTERY_BONUS_FINAL_DAMAGE2 = GetPrivateProfileInt(section, "MASTERY_BONUS_FINAL_DAMAGE2", 17, path);
	this->MASTERY_BONUS_ULTRAHIT_502 = GetPrivateProfileInt(section, "MASTERY_BONUS_ULTRAHIT_502", 2, path);
	this->MASTERY_BONUS_DOUBLE_DAMAGE_BOSS2 = GetPrivateProfileInt(section, "MASTERY_BONUS_DOUBLE_DAMAGE_BOSS2", 7, path);

	//shield
	this->MASTERY_OPTION_PVP_DAMAGE_REDUCTION = GetPrivateProfileInt(section, "MASTERY_OPTION_PVP_DAMAGE_REDUCTION", 25, path);
	this->MASTERY_OPTION_ELEMENTAL_DAMAGE_REDUCTION = GetPrivateProfileInt(section, "MASTERY_OPTION_ELEMENTAL_DAMAGE_REDUCTION", 30, path);
	this->MASTERY_OPTION_DOUBLE_DAMAGE_PROTECTION = GetPrivateProfileInt(section, "MASTERY_OPTION_DOUBLE_DAMAGE_PROTECTION", 10, path);
	this->MASTERY_OPTION_TRIPLE_DAMAGE_PROTECTION = GetPrivateProfileInt(section, "MASTERY_OPTION_TRIPLE_DAMAGE_PROTECTION", 3, path);
	this->MASTERY_OPTION_TRUE_DAMAGE_PROTECTION = GetPrivateProfileInt(section, "MASTERY_OPTION_TRUE_DAMAGE_PROTECTION", 1, path);
	this->MASTERY_OPTION_ULTRAHIT_PROTECTION = GetPrivateProfileInt(section, "MASTERY_OPTION_ULTRAHIT_PROTECTION", 1, path);
	//shield blue eye
	this->MASTERY_OPTION_PVP_DAMAGE_REDUCTION_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_PVP_DAMAGE_REDUCTION_2", 30, path);
	this->MASTERY_OPTION_ELEMENTAL_DAMAGE_REDUCTION_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_ELEMENTAL_DAMAGE_REDUCTION_2", 35, path);
	this->MASTERY_OPTION_DOUBLE_DAMAGE_PROTECTION_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_DOUBLE_DAMAGE_PROTECTION_2", 13, path);
	this->MASTERY_OPTION_TRIPLE_DAMAGE_PROTECTION_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_TRIPLE_DAMAGE_PROTECTION_2", 4, path);
	this->MASTERY_OPTION_TRUE_DAMAGE_PROTECTION_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_TRUE_DAMAGE_PROTECTION_2", 2, path);
	this->MASTERY_OPTION_ULTRAHIT_PROTECTION_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_ULTRAHIT_PROTECTION_2", 2, path);	
	//shield Silver Heart
	this->MASTERY_OPTION_PVP_DAMAGE_REDUCTION_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_PVP_DAMAGE_REDUCTION_3", 35, path);
	this->MASTERY_OPTION_ELEMENTAL_DAMAGE_REDUCTION_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_ELEMENTAL_DAMAGE_REDUCTION_3", 40, path);
	this->MASTERY_OPTION_DOUBLE_DAMAGE_PROTECTION_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_DOUBLE_DAMAGE_PROTECTION_3", 15, path);
	this->MASTERY_OPTION_TRIPLE_DAMAGE_PROTECTION_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_TRIPLE_DAMAGE_PROTECTION_3", 5, path);
	this->MASTERY_OPTION_TRUE_DAMAGE_PROTECTION_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_TRUE_DAMAGE_PROTECTION_3", 3, path);
	this->MASTERY_OPTION_ULTRAHIT_PROTECTION_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_ULTRAHIT_PROTECTION_3", 3, path);
	//shield bonus
	this->MASTERY_BONUS_HP_DAMAGE_PROTECTION = GetPrivateProfileInt(section, "MASTERY_BONUS_HP_DAMAGE_PROTECTION", 2, path);
	this->MASTERY_BONUS_REFLECT_INCREASE = GetPrivateProfileInt(section, "MASTERY_BONUS_REFLECT_INCREASE", 40, path);
	this->MASTERY_BONUS_BOSS_POWER_PROTECTION = GetPrivateProfileInt(section, "MASTERY_BONUS_BOSS_POWER_PROTECTION", 15, path);
	//shield blue eye bonus
	this->MASTERY_BONUS_HP_DAMAGE_PROTECTION_2 = GetPrivateProfileInt(section, "MASTERY_BONUS_HP_DAMAGE_PROTECTION_2", 3, path);
	this->MASTERY_BONUS_REFLECT_INCREASE_2 = GetPrivateProfileInt(section, "MASTERY_BONUS_REFLECT_INCREASE_2", 50, path);
	this->MASTERY_BONUS_BOSS_POWER_PROTECTION_2 = GetPrivateProfileInt(section, "MASTERY_BONUS_BOSS_POWER_PROTECTION_2", 30, path);
	//shield silver heart bonus
	this->MASTERY_BONUS_HP_DAMAGE_PROTECTION_3 = GetPrivateProfileInt(section, "MASTERY_BONUS_HP_DAMAGE_PROTECTION_3", 4, path);
	...
	this->MASTERY_OPTION_TRIPLE_DAMAGE_RATE = GetPrivateProfileInt(section, "MASTERY_OPTION_TRIPLE_DAMAGE_RATE", 3, path);
	this->MASTERY_OPTION_DOUBLE_DAMAGE_RATE = GetPrivateProfileInt(section, "MASTERY_OPTION_DOUBLE_DAMAGE_RATE", 10, path);
	this->MASTERY_OPTION_PVP_DAMAGE_INCREASE = GetPrivateProfileInt(section, "MASTERY_OPTION_PVP_DAMAGE_INCREASE", 25, path);
	this->MASTERY_OPTION_BOSS_DAMAGE_INCREASE = GetPrivateProfileInt(section, "MASTERY_OPTION_BOSS_DAMAGE_INCREASE", 25, path);
	this->MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE_WEAPON = GetPrivateProfileInt(section, "MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE_WEAPON", 30, path);
	//Armas blue eye
	this->MASTERY_OPTION_BOSS_DECREASE_DELAY_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_BOSS_DECREASE_DELAY_2", 30, path);
	this->MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE_WEAPON_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE_WEAPON_2", 35, path);
	this->MASTERY_OPTION_BOSS_DAMAGE_INCREASE_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_BOSS_DAMAGE_INCREASE_2", 35, path);
	this->MASTERY_OPTION_PVP_DAMAGE_INCREASE_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_PVP_DAMAGE_INCREASE_2", 30, path);
	this->MASTERY_OPTION_DOUBLE_DAMAGE_RATE_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_DOUBLE_DAMAGE_RATE_2", 13, path);
	this->MASTERY_OPTION_TRIPLE_DAMAGE_RATE_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_TRIPLE_DAMAGE_RATE_2", 4, path);
	this->MASTERY_OPTION_TRUE_DAMAGE_RATE_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_TRUE_DAMAGE_RATE_2", 3, path);
	this->MASTERY_OPTION_30P_HP_ULTRAHIT_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_30P_HP_ULTRAHIT_2", 2, path);
	
	//Armas Silver Heart
	this->MASTERY_OPTION_BOSS_DECREASE_DELAY_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_BOSS_DECREASE_DELAY_3", 35, path);
	this->MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE_WEAPON_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_ELEMENTAL_DAMAGE_INCREASE_WEAPON_3", 40, path);
	this->MASTERY_OPTION_BOSS_DAMAGE_INCREASE_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_BOSS_DAMAGE_INCREASE_3", 40, path);
	this->MASTERY_OPTION_PVP_DAMAGE_INCREASE_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_PVP_DAMAGE_INCREASE_3", 35, path);
	this->MASTERY_OPTION_DOUBLE_DAMAGE_RATE_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_DOUBLE_DAMAGE_RATE_3", 15, path);
	this->MASTERY_OPTION_TRIPLE_DAMAGE_RATE_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_TRIPLE_DAMAGE_RATE_3", 5, path);
	this->MASTERY_OPTION_TRUE_DAMAGE_RATE_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_TRUE_DAMAGE_RATE_3", 4, path);
	this->MASTERY_OPTION_30P_HP_ULTRAHIT_3 = GetPrivateProfileInt(section, "MASTERY_OPTION_30P_HP_ULTRAHIT_3", 3, path);

	this->MASTERY_OPTION_PENDANT_PVP_DMG = GetPrivateProfileInt(section, "MASTERY_OPTION_PENDANT_PVP_DMG", 10, path);
	this->MASTERY_OPTION_PENDANT_TRIPLE_DMG = GetPrivateProfileInt(section, "MASTERY_OPTION_PENDANT_TRIPLE_DMG", 1, path);
	this->MASTERY_OPTION_PENDANT_TRUE_DMG = GetPrivateProfileInt(section, "MASTERY_OPTION_PENDANT_TRUE_DMG", 1, path);
	this->MASTERY_OPTION_PENDANT_DOUBLE_DMG = GetPrivateProfileInt(section, "MASTERY_OPTION_PENDANT_DOUBLE_DMG", 10, path);
	this->MASTERY_OPTION_PENDANT_BOSS_DMG = GetPrivateProfileInt(section, "MASTERY_OPTION_PENDANT_BOSS_DMG", 10, path);
	this->MASTERY_OPTION_PENDANT_BOSS_DECREASE_DELAY = GetPrivateProfileInt(section, "MASTERY_OPTION_PENDANT_BOSS_DECREASE_DELAY", 10, path);
	this->MASTERY_OPTION_PENDANT_ELEMENTAL_DAMAGE_INCREASE = GetPrivateProfileInt(section, "MASTERY_OPTION_PENDANT_ELEMENTAL_DAMAGE_INCREASE", 15, path);
	this->MASTERY_OPTION_PENDANT_BACKSPRING_INCREASE = GetPrivateProfileInt(section, "MASTERY_OPTION_PENDANT_BACKSPRING_INCREASE", 15, path);

	this->MASTERY_BONUS_PENDANT_CURE_HARM = GetPrivateProfileInt(section, "MASTERY_BONUS_PENDANT_CURE_HARM", 1, path);
	this->MASTERY_BONUS_PENDANT_STERN = GetPrivateProfileInt(section, "MASTERY_BONUS_PENDANT_STERN", 1, path);
	this->MASTERY_BONUS_PENDANT_BLEEDING = GetPrivateProfileInt(section, "MASTERY_BONUS_PENDANT_BLEEDING", 1, path);
	this->MASTERY_BONUS_PENDANT_SHIELD_SKILL_IGNORE = GetPrivateProfileInt(section, "MASTERY_BONUS_PENDANT_SHIELD_SKILL_IGNORE", 1, path);
	this->MASTERY_BONUS_PENDANT_ULTRAHIT_50 = GetPrivateProfileInt(section, "MASTERY_BONUS_PENDANT_ULTRAHIT_50", 1, path);
	this->MASTERY_BONUS_PENDANT_FREEZING = GetPrivateProfileInt(section, "MASTERY_BONUS_PENDANT_FREEZING", 1, path); 

	this->MASTERY_OPTION_RING_BACKSPRING_PROTECTION = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_BACKSPRING_PROTECTION", 15, path);
	this->MASTERY_OPTION_RING_DROP_BOSS_INC = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_DROP_BOSS_INC", 10, path);
	this->MASTERY_OPTION_RING_MAX_HP_INC = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_MAX_HP_INC", 5, path);
	this->MASTERY_OPTION_RING_BLOCK_CHANCE_INC = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_BLOCK_CHANCE_INC", 2, path);
	this->MASTERY_OPTION_RING_BOSS_SKILL_PROTECTION = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_BOSS_SKILL_PROTECTION", 10, path);
	this->MASTERY_OPTION_RING_ELEMENTAL_DMG_REDUCE = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_ELEMENTAL_DMG_REDUCE", 10, path);
	this->MASTERY_OPTION_RING_PVP_DAMAGE_REDUCE = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_PVP_DAMAGE_REDUCE", 5, path);
	this->MASTERY_OPTION_RING_BOSS_DAMAGE_REDUCE = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_BOSS_DAMAGE_REDUCE", 5, path);
	this->MASTERY_OPTION_RING_TRIPLE_DMG_PROTECTION = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_TRIPLE_DMG_PROTECTION", 1, path);
	this->MASTERY_OPTION_RING_TRUE_DMG_PROTECTION = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_TRUE_DMG_PROTECTION", 1, path);
	this->MASTERY_OPTION_RING_ULTRAHIT_PROTECTION = GetPrivateProfileInt(section, "MASTERY_OPTION_RING_ULTRAHIT_PROTECTION", 3, path);

	this->MASTERY_BONUS_RING_STERN_RESIST = GetPrivateProfileInt(section, "MASTERY_BONUS_RING_STERN_RESIST", 50, path);
	this->MASTERY_BONUS_RING_BLEEDING_RESIST = GetPrivateProfileInt(section, "MASTERY_BONUS_RING_BLEEDING_RESIST", 50, path);
	this->MASTERY_BONUS_RING_CURE_HARM_RESIST = GetPrivateProfileInt(section, "MASTERY_BONUS_RING_CURE_HARM_RESIST", 50, path);
	this->MASTERY_BONUS_RING_CURE_IMPROVE = GetPrivateProfileInt(section, "MASTERY_BONUS_RING_CURE_IMPROVE", 10, path);
	this->MASTERY_BONUS_RING_FULL_REFLECT_INC = GetPrivateProfileInt(section, "MASTERY_BONUS_RING_FULL_REFLECT_INC", 2, path);
	this->MASTERY_BONUS_RING_MASTERY_REVERT = GetPrivateProfileInt(section, "MASTERY_BONUS_RING_MASTERY_REVERT", 20, path);
	...
	this->MASTERY_BONUS_BLEEDING = GetPrivateProfileInt(section, "MASTERY_BONUS_BLEEDING", 1, path);
	this->MASTERY_BONUS_STERN_RATE = GetPrivateProfileInt(section, "MASTERY_BONUS_STERN_RATE", 1, path);
	this->MASTERY_BONUS_CURE_HARM = GetPrivateProfileInt(section, "MASTERY_BONUS_CURE_HARM", 1, path);
	this->MASTERY_BONUS_CURE_HARM_FACTOR = GetPrivateProfileInt(section, "MASTERY_BONUS_CURE_HARM_FACTOR", 15, path);
	//armas blue eye bonus
	this->MASTERY_BONUS_ULTRAHIT_50_WEAPON_2 = GetPrivateProfileInt(section, "MASTERY_BONUS_ULTRAHIT_50_WEAPON_2", 1, path);
	this->MASTERY_BONUS_REFLECT_DECREASE_2 = GetPrivateProfileInt(section, "MASTERY_BONUS_REFLECT_DECREASE_2", 50, path);	
	this->MASTERY_BONUS_DOUBLE_DAMAGE_BOSS_WEAPON_2 = GetPrivateProfileInt(section, "MASTERY_BONUS_DOUBLE_DAMAGE_BOSS_WEAPON_2", 5, path);
	this->MASTERY_BONUS_BLEEDING_2 = GetPrivateProfileInt(section, "MASTERY_BONUS_BLEEDING_2", 1, path);
	this->MASTERY_BONUS_STERN_RATE_2 = GetPrivateProfileInt(section, "MASTERY_BONUS_STERN_RATE_2", 1, path);
	this->MASTERY_BONUS_CURE_HARM_2 = GetPrivateProfileInt(section, "MASTERY_BONUS_CURE_HARM_2", 1, path);
	this->MASTERY_BONUS_FREEZING_DAMAGE = GetPrivateProfileInt(section, "MASTERY_BONUS_FREEZING_DAMAGE", 2, path);
	//armas silver heart bonus
	this->MASTERY_BONUS_ULTRAHIT_50_WEAPON_3 = GetPrivateProfileInt(section, "MASTERY_BONUS_ULTRAHIT_50_WEAPON_3", 3, path);
	this->MASTERY_BONUS_REFLECT_DECREASE_3 = GetPrivateProfileInt(section, "MASTERY_BONUS_REFLECT_DECREASE_3", 60, path);
	this->MASTERY_BONUS_DOUBLE_DAMAGE_BOSS_WEAPON_3 = GetPrivateProfileInt(section, "MASTERY_BONUS_DOUBLE_DAMAGE_BOSS_WEAPON_3", 10, path);
	this->MASTERY_BONUS_BLEEDING_3 = GetPrivateProfileInt(section, "MASTERY_BONUS_BLEEDING_3", 3, path);
	this->MASTERY_BONUS_STERN_RATE_3 = GetPrivateProfileInt(section, "MASTERY_BONUS_STERN_RATE_3", 3, path);
	this->MASTERY_BONUS_CURE_HARM_3 = GetPrivateProfileInt(section, "MASTERY_BONUS_CURE_HARM_3", 3, path);
	this->MASTERY_BONUS_FREEZING_DAMAGE_2 = GetPrivateProfileInt(section, "MASTERY_BONUS_FREEZING_DAMAGE_2", 3, path);
	this->MASTERY_BONUS_FIREING_DAMAGE = GetPrivateProfileInt(section, "MASTERY_BONUS_FIREING_DAMAGE", 2, path);
}

void CServerInfo::ReadCharacterElementalInfo(char* section, char* path) // OK
{
	char GameServerInfo[100] = { 0 };
	...
	this->m_CastleSiegeElementalDamageRate = GetPrivateProfileInt(section, "CastleSiegeElementalDamageRate", 0, path);
	...
	this->m_ElementalDamageRatePvP[7] = GetPrivateProfileInt(section, "GLElementalDamageRatePvP", 0, path);

	this->m_ElementalDamageRatePvM[0] = GetPrivateProfileInt(section, "DWElementalDamageRatePvM", 100, path);
	this->m_ElementalDamageRatePvM[1] = GetPrivateProfileInt(section, "DKElementalDamageRatePvM", 100, path);
	this->m_ElementalDamageRatePvM[2] = GetPrivateProfileInt(section, "FEElementalDamageRatePvM", 100, path);
	this->m_ElementalDamageRatePvM[3] = GetPrivateProfileInt(section, "MGElementalDamageRatePvM", 100, path);
	this->m_ElementalDamageRatePvM[4] = GetPrivateProfileInt(section, "DLElementalDamageRatePvM", 100, path);
	this->m_ElementalDamageRatePvM[5] = GetPrivateProfileInt(section, "SUElementalDamageRatePvM", 100, path);
	this->m_ElementalDamageRatePvM[6] = GetPrivateProfileInt(section, "RFElementalDamageRatePvM", 100, path);
	this->m_ElementalDamageRatePvM[7] = GetPrivateProfileInt(section, "GLElementalDamageRatePvM", 100, path);
	...
	this->m_ElementalDamageRateTo[7][0] = GetPrivateProfileInt(section, "GLElementalDamageRateToDW", 0, path);
	this->m_ElementalDamageRateTo[7][1] = GetPrivateProfileInt(section, "GLElementalDamageRateToDK", 0, path);
	this->m_ElementalDamageRateTo[7][2] = GetPrivateProfileInt(section, "GLElementalDamageRateToFE", 0, path);
	this->m_ElementalDamageRateTo[7][3] = GetPrivateProfileInt(section, "GLElementalDamageRateToMG", 0, path);
	this->m_ElementalDamageRateTo[7][4] = GetPrivateProfileInt(section, "GLElementalDamageRateToDL", 0, path);
	this->m_ElementalDamageRateTo[7][5] = GetPrivateProfileInt(section, "GLElementalDamageRateToSU", 0, path);
	this->m_ElementalDamageRateTo[7][6] = GetPrivateProfileInt(section, "GLElementalDamageRateToRF", 0, path);
	this->m_ElementalDamageRateTo[7][7] = GetPrivateProfileInt(section, "GLElementalDamageRateToGL", 0, path);
	...
	this->m_FKElementalDefenseConstA = GetPrivateProfileInt(section, "GLElementalDefenseConstA", 0, path);
	...
	this->m_FKElementalDamageMinConstA = GetPrivateProfileInt(section, "GLElementalDamageMinConstA", 0, path);
	this->m_FKElementalDamageMaxConstA = GetPrivateProfileInt(section, "GLElementalDamageMaxConstA", 0, path);
	...
	this->m_FKElementalAttackSuccessRateConstA = GetPrivateProfileInt(section, "GLElementalAttackSuccessRateConstA", 0, path);
	this->m_FKElementalAttackSuccessRateConstB = GetPrivateProfileInt(section, "GLElementalAttackSuccessRateConstB", 0, path);
	this->m_FKElementalAttackSuccessRateConstC = GetPrivateProfileInt(section, "GLElementalAttackSuccessRateConstC", 0, path);
	this->m_FKElementalAttackSuccessRateConstD = GetPrivateProfileInt(section, "GLElementalAttackSuccessRateConstD", 0, path);
	...
	this->m_FKElementalDefenseSuccessRateConstA = GetPrivateProfileInt(section, "GLElementalDefenseSuccessRateConstA", 0, path);
}
...
void CServerInfo::ReadCommandConfig()
{
	...
	this->m_CommandMasterResetRuudBonus[0] = GetPrivateProfileInt("MASTERRESET", "RuudBonus_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetRuudBonus[1] = GetPrivateProfileInt("MASTERRESET", "RuudBonus_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetRuudBonus[2] = GetPrivateProfileInt("MASTERRESET", "RuudBonus_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetRuudBonus[3] = GetPrivateProfileInt("MASTERRESET", "RuudBonus_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	...
	this->m_CommandRemoveWingOptionRuud = GetPrivateProfileInt("COIN", "RuudRemoveWingOption", 1000000, gPath.GetRightPath("Commands\\Coin.ini"));
...
void CServerInfo::ReadCommonInfo(char* section, char* path) // OK
{
	...
	this->m_PKRuudDrop = GetPrivateProfileInt(section, "PKRuud", 0, path);
	this->m_PKRuudTax = GetPrivateProfileInt(section, "PKTax", 0, path);
	this->m_PKItemDrop = GetPrivateProfileInt(section, "PKItem", 0, path);

	this->m_PartyTeleportDelay = GetPrivateProfileInt(section, "PartyTeleportDelay", 20000, path);

	this->m_TradeSwitch = GetPrivateProfileInt(section, "TradeSwitch", 0, path);

	this->m_OficinaSwitch = GetPrivateProfileInt(section, "OficinaSwitch", 0, path);
	...
	this->m_GuildBattleMasterLimit = GetPrivateProfileInt(section, "GuildBattleMasterLimit", 5, path);
	this->m_GuildAssistentLimit = GetPrivateProfileInt(section, "GuildAssistentLimit", 1, path);
	...
	this->m_LevelUpPoint[7] = GetPrivateProfileInt(section, "GLLevelUpPoint", 0, path);
	...
	this->m_GLCreateLevel[0] = GetPrivateProfileInt(section, "GLCreateLevel_AL0", 0, path);
	this->m_GLCreateLevel[1] = GetPrivateProfileInt(section, "GLCreateLevel_AL1", 0, path);
	this->m_GLCreateLevel[2] = GetPrivateProfileInt(section, "GLCreateLevel_AL2", 0, path);
	this->m_GLCreateLevel[3] = GetPrivateProfileInt(section, "GLCreateLevel_AL3", 0, path);
	...
	this->m_MysteriouStoneSetApplyRate			= GetPrivateProfileInt(section, "MysteriouStoneSetApplyRate", 0, path);
	this->m_MysteriouStoneBlueEyeSetApplyRate	= GetPrivateProfileInt(section, "MysteriouStoneBlueEyeSetApplyRate", 0, path);
	this->m_MysteriouStoneSilverHeartSetApplyRate = GetPrivateProfileInt(section, "MysteriouStoneSilverHeartSetApplyRate", 0, path);
	this->m_MysteriouStoneWeaponApplyRate		= GetPrivateProfileInt(section, "MysteriouStoneWeaponApplyRate", 0, path);
	this->m_MysteriouStoneBlueEyeWeaponApplyRate= GetPrivateProfileInt(section, "MysteriouStoneBlueEyeWeaponApplyRate", 0, path);
	this->m_MysteriouStoneSilverHeartWeaponApplyRate = GetPrivateProfileInt(section, "MysteriouStoneSilverHeartWeaponApplyRate", 0, path);
	this->m_MysteriouStoneShieldApplyRate		= GetPrivateProfileInt(section, "MysteriouStoneShieldApplyRate", 0, path);
	this->m_MysteriouStoneRingApplyRate			= GetPrivateProfileInt(section, "MysteriouStoneRingApplyRate", 0, path);
	this->m_MysteriouStonePendantApplyRate		= GetPrivateProfileInt(section, "MysteriouStonePendantApplyRate", 0, path);	
}
...
void CServerInfo::ReadEventInfo(char* section, char* path) // OK
{
	...
	this->m_BloodCastleRewardParty	= GetPrivateProfileInt(section, "BloodCastleRewardParty", 1, path);
	...
	this->m_SilvesterMaxPlayers = GetPrivateProfileInt(section, "SilvesterMaxPlayers", 5, path);

	this->m_GodOfDarknessMaxPlayers = GetPrivateProfileInt(section, "GodOfDarknessMaxPlayers", 5, path);
	this->m_GodOfDarknessWarningTime = GetPrivateProfileInt(section, "GodOfDarknessWarningTime", 5, path);

	this->m_NixDevilIceDelay = GetPrivateProfileInt(section, "NixDevilIceDelay", 60, path);
	this->m_NixRegenTime = GetPrivateProfileInt(section, "NixRegenTime", 30, path);
	this->m_NixDieTime = GetPrivateProfileInt(section, "NixDieTime", 5, path);
	this->m_NixRestrictPC = GetPrivateProfileInt(section, "NixRestrictPC", 0, path);

	this->m_MagicMazeEvent = GetPrivateProfileInt(section, "MagicMazeEvent", 0, path);

	this->OrdnaelEggDropRate = GetPrivateProfileInt(section, "OrdnaelEggDropRate", 3, path);
}
...
void CServerInfo::ReadHackInfo(char* section, char* path) // OK
{
	...
	this->m_CheckAutoPotionHackTolerance = GetPrivateProfileInt(section, "CheckAutoPotionHackTolerance", 200, path);
	this->m_CheckAutoAntidoteHackTolerance = GetPrivateProfileInt(section, "CheckAutoAntidoteHackTolerance", 500, path);
...
void CServerInfo::ReadSkillInfo(char* section, char* path) // OK
{
	...
	this->m_BackSpringDelay = GetPrivateProfileInt(section, "BackSpringDelay", 0, path);
